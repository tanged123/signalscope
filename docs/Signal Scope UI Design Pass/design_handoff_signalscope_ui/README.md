...
Transforms: docked formula bar — `derived/name = expr`, `$("path")` refs, `deriv/integ/smooth`, Math.*; ↵ create, ↑ history, esc collapse. Quick transforms duplicated in legend inspector.
