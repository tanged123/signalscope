...
export const SESSION_SCHEMA_VERSION = 34 as const;
...
export interface Annotation {
  ...
  histogram_window: [number, number] | null;
...
export interface PanelState {
  ...
  x_axis: SampleAxisSource;
  color_axis: ColorAxis | null;
