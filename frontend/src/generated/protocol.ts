...
export interface EnsembleBin {
  t0: number;
  t1: number;
  min_run_mean: number | null;
  max_run_mean: number | null;
  mean_of_run_means: number | null;
  sigma: number | null;
  run_count: number;
}

export interface EnsembleTileRequest {
  request_id: string;
  set_id: string;
  local_path: string;
  window: TimeWindow;
...
export interface EnsembleTileResponse {
  request_id: string;
  set_key: string;
  generation: string;
  level: number;
